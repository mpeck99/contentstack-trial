...
exports.set = set;
var _localstorage = _interopRequireDefault(__webpack_require__(591));
function _interopRequireDefault(e) {
  return e && e.__esModule ? e : {
    "default": e
  };
...
var _http = _interopRequireDefault(__webpack_require__(215));
function _interopRequireDefault(e) {
  return e && e.__esModule ? e : {
    "default": e
  };
  ...
  (0, _http["default"])(request.url, request.option).then(function (response) {
    ...
    if (response.ok && response.status === 200) {
      data.then(function (json) {
        for (var _index = 0; _index < plugins.length && typeof plugins[_index].onResponse === 'function'; _index++) json = plugins[_index].onResponse(stack, request, response, json);
        resolve(json);
      });
    } else {
            ...
            while (1) switch (_context2.prev = _context2.next) {
              case 0:
                ...
                return self.provider.get(hashQuery, /*#__PURE__*/function () {
                  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(err, _data) {
                    return _regeneratorRuntime().wrap(function _callee$(_context) {
                      while (1) switch (_context.prev = _context.next) {
                        ...
                        case 5:
                          ...
                          return _context.abrupt("return", resolve(spreadResult(_data)));
                        case 7:
                          _context.next = 12;
                          break;
                        case 9:
        ...
        for (var key in params) {
          if (params.hasOwnProperty(key)) {
            if (typeof params[key] !== "string" && typeof params[key] !== "number") {
              throw new Error("Invalid parameter value for key \"".concat(key, "\": must be a string or number."));
            }
