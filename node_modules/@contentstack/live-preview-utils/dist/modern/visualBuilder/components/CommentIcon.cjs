...
function CommentIcon(props) {
  ...
  (0, import_compat.useEffect)(() => {
    ...
    const recieveDiscussionIDEvent = import_visualBuilderPostMessage.default?.on(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    "button",
    {
      ...
      children: activeDiscussion?.uid === "new" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.AddCommentIcon, {}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.ReadCommentIcon, {})
    }
  );
}
