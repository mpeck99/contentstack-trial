...
function handleDeleteInstance(fieldMetadata) {
  import_visualBuilderPostMessage.default?.send(import_postMessage.VisualBuilderPostMessageEvents.DELETE_INSTANCE, {
...
function handleMoveInstance(fieldMetadata, direction) {
  import_visualBuilderPostMessage.default?.send(import_postMessage.VisualBuilderPostMessageEvents.MOVE_INSTANCE, {
    data: fieldMetadata.fieldPathWithIndex + "." + fieldMetadata.multipleFieldMetadata.index,
    direction,
    fieldMetadata
  }).finally(closeOverlay);
