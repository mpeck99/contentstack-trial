...
var getFieldData_exports = {};
__export(getFieldData_exports, {
  getFieldData: () => getFieldData
});
module.exports = __toCommonJS(getFieldData_exports);
...
async function getFieldData(fieldMetadata, entryPath) {
  const data = await import_visualBuilderPostMessage.default?.send(
    import_postMessage.VisualBuilderPostMessageEvents.GET_FIELD_DATA,
    { fieldMetadata, entryPath: entryPath ?? "" }
  );
  if ((0, import_errorHandling.hasPostMessageError)(data)) {
    return "";
  }
...
//# sourceMappingURL=getFieldData.cjs.map