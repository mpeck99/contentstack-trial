...
type NuxtAppInjections = 
  ...
  InjectionType<typeof import("../../plugins/lodash").default> &
  InjectionType<typeof import("../../plugins/contentstack").default> &
  InjectionType<typeof import("../../plugins/sanitizeDom").default>

declare module '#app' {
  interface NuxtApp extends NuxtAppInjections { }

  interface NuxtAppLiterals {
    pluginName: 'nuxt:revive-payload:client' | 'nuxt:head' | 'nuxt:router' | 'contentstack-sdk' | 'nuxt:revive-payload:server' | 'nuxt:global-components' | 'nuxt:prefetch' | 'nuxt:checkIfPageUnused' | 'nuxt:chunk-reload' | 'nuxt:checkIfLayoutUsed'
  }
}
